...
Ta = (Ra.row_join(Matrix([[0],[0],[0]]))).col_join(col)

Tb_a = (Rb_a.row_join(tb_a)).col_join(col)

Te_b = (Re_b.row_join(te_b)).col_join(col)

Tc_a = (Rc_a.row_join(tc_a)).col_join(col)

Td_c = (Rd_c.row_join(td_c)).col_join(col)

Te_d = (Re_d.row_join(te_d)).col_join(col)
